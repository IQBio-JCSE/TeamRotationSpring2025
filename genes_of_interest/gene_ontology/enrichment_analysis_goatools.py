...
gaf_file = "input/GCF_002127325.2_HanXRQr2.0-SUNRISE_gene_ontology.gaf" #TODO: make this var we can pass in 
gene2go = read_gaf(gaf_file, prt=None)

# Load background genes
background_gene_f = "input/background_genes_NCBI_ID.list"
with open(background_gene_f) as f:
    background_genes = set(line.strip() for line in f)

# deg_file = "filtered_genes.csv" #TODO: make this var we can pass in 
deg_file = "input/diff_expr_genes_NCBI_ID.list" 
